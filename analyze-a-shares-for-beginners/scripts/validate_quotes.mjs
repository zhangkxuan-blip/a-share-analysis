...
export function validateQuotePair(primary, secondary, options = {}) {
  ...
  for (const [label, quote] of [["primary", primary], ["secondary", secondary]]) {
    ...
    if (label === "primary" && sourceMs !== null && nowMs !== null && quote.market_phase === "continuous_auction" && nowMs - sourceMs > maxAgeSeconds * 1000) addError(errors, "stale_primary", "age exceeds " + maxAgeSeconds + " seconds");
